...
const Payment = () => {
  ...
  const handlePayment = async () => {
    ...
    const order = await fetch("https://two-airbnb-backend-wrgi.onrender.com/api/payment/create-order", {
      method: "POST",
    ...
    const options = {
      ...
      handler: async function (response) {
        // 3️⃣ Verify Payment
        const verify = await fetch("https://two-airbnb-backend-wrgi.onrender.com/api/payment/create-order",{
          method: "POST",
          headers: { "Content-Type": "application/json" },
